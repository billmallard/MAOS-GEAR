...
Thanks for contributing to MAOS-GEAR.
...
- Analysis and tooling code: .py, .m, .cpp, .c
...
- CAD models and engineering drawings (STEP, DXF, STL)
- Load-case data, stress reports, and diagrams

## Pull Request Expectations

- Keep changes scoped and reviewable.
- Keep units, interfaces, load assumptions, and fault semantics explicit.
- Include evidence for behavior claims (analysis outputs, bench logs, test artifacts).
